...
class RSIReversalShort(Strategy):
    ...
    def generate_pending(self, prices: pd.DataFrame, history_days: int) -> pd.DataFrame:
        """
        Emit signals that have printed (RSI>=70 + bearish engulfing) but have
                ...
                rows.append(
                    {
                        ...
                        "Reason": "RSI>=70 + bearish engulfing; awaiting trigger within 3 bars",
                    }
                )
