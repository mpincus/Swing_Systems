...
class BullFlagLong(Strategy):
    name = "bull_flag_long"
    urls = [
        "https://finviz.com/screener.ashx?v=111&f=cap_midover,geo_usa,sh_opt_option,sh_price_o30,sh_avgvol_o1000,ta_pattern_bullflag"
    ]
    ...
    def generate(self, prices: pd.DataFrame, history_days: int) -> pd.DataFrame:
        ...
        latest["Reason"] = "Finviz bull flag pattern; GPT to set stop/target"
